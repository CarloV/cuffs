...
(function(){
  ...
  Cuffs = function(arg$){
    var ref$, customTypes, ref1$, parseRegexTypes, useProxies, onError, modes, literals, prox, _up, openTag, goDown, OOError, processCustomTypes, parseToArray, parseToFunction, x$, y$, k, z$, z1$, z2$, mt, OO;
    ref$ = arg$ != null
      ? arg$
      : {}, customTypes = (ref1$ = ref$.customTypes) != null
      ? ref1$
      : {}, parseRegexTypes = (ref1$ = ref$.parseRegexTypes) != null ? ref1$ : true, useProxies = (ref1$ = ref$.useProxies) != null ? ref1$ : false, onError = ref$.onError;
    modes = {};
    literals = lits;
    prox = Proxy;
    _up = function(it){
